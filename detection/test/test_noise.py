...
def main():
    ...
    '''
    When the noise is decreased(e.g. np.random.normal(0, 5, 200)), both detecting algorithms can't detect the drift.
    '''
    noise = np.random.normal(0, 5, 200)

    # Add noise to sinus signals.
    data_stream[900:1100] = data_stream[900:1100] + noise
